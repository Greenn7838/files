...
PowerShell -NoProfile -ExecutionPolicy Bypass -Command "curl -o Trigon.zip https://github.com/Greenn7838/Butter-s-awesome-repo/raw/main/Trigon_Evo_Installer_v2.5.zip"
